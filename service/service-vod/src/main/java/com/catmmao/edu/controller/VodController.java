...
public class VodController {
     ...
     * @return 视频凭证
     */
    @GetMapping("/play_auth/{id}")
    public ResponseEntity<CommonResponse<String>> getVideoPlayAuth(@PathVariable String id) {
        String data = videoService.getVideoPlayAuth(id);
